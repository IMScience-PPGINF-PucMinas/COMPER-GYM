...
@click.option("--logfreq", type=int, default=10,show_default=True)
@click.option("--net_param_dir", type=str, default='dev',show_default=True)
@click.option("--upd_target_freq", type=int, default=10,show_default=True)
...
@click.option("--lr_start_it", type=int, default=10,show_default=True)
...
def main(rom,logdir, logfreq, net_param_dir, upd_target_freq, upd_q_freq,save_param_frq, lr_start_it, memorydir, 
        maxtotalframes,frames_ep_decay,persist_memories,no_save_params):
